...
export type LocaleMeta = {
  id: Locale;
  /** Name shown in the language itself, e.g. "العربية". */
  nativeLabel: string;
  /** English name, for reference. */
  englishLabel: string;
  /** Text direction — drives the RTL pass (L5). */
  dir: "ltr" | "rtl";
};

export const LOCALES: LocaleMeta[] = [
  { id: "en", nativeLabel: "English", englishLabel: "English", dir: "ltr" },
  { id: "ar", nativeLabel: "العربية", englishLabel: "Arabic", dir: "rtl" },
];

export const DEFAULT_LOCALE: Locale = "en";

/** Translation keys used across the admin panel. Add keys here as screens need them. */
